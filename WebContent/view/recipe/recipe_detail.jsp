...
<script type="text/javascript">
	function voice_service() {
		window.open("voice_service.jsp", "레시피 읽어주기!",
				"width=1300, height=1080, left=100, top=0")
	}
</script>
...
<body>
	...
	<div class="section_top">
		...
		<input type="hidden" name="command" value="recipe_update"/>
		<input type="hidden" name="recipe_no" value="${dto.recipe_no}">
			<div class="recipe_wrap_top">
				...
				<div class="speech_wrap">
					<button type="button" onclick="voice_service()"
						class="speech_button">
	...
	<div class="section_bottom">
		...
		<c:forEach items="${detail }" var="d" varStatus="status">
			...
			<div class="recipe_wrap_bottom">
				...
				<!-- 단계별 래시피 글 -->
				<div class="recipe_content">${d}</div>
			</div>
