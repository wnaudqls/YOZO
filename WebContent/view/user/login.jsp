...
<script>
	...
	var N = document.getElementById("naverIdLogin_LoginButton");
	
	var naverLogin = new naver.LoginWithNaverId({
			clientId: "Ks9_WH5_tblK4R7HY9FB",
//			callbackUrl: "https://127.0.0.1/YORIZORI/user.do?command=login",
			callbackUrl: "https://127.0.0.1/YORIZORI/view/user/login.jsp",
