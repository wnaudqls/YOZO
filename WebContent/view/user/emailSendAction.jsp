...
<%@page import="com.yozo.user.util.Gmail"%>
...
<%
	...
	boolean emailChecked = userDao.getUserEmailChecked(member_id);
	...
	String host = "http://localhost:8787/YORIZORI/";

	String from = "이메일 아이디";

	String to = userDao.getUserEmail(member_id);
