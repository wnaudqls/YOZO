						...
						success : function(data) {
							...
							if (cCnt > 0) {
								for (i = 0; i < cCnt; i++) {
									 ...
									 */
									ele += "<div>";
									ele += "<div><table class='table'><strong>"
											+ result[i].member_nick + " : </strong>";
									ele += result[i].goods_re_content+"<tr><td>"
									ele += "<input type='button' value='댓글' class='rebtn' onclick='rereply("+ i + ");'>";
									ele += "<td><tr></table></div>";
									ele += "</div>";
								}
			...
			newButton
					.addEventListener(
							...
							function(event) {
								...
								var greno = $(this).parent().parent().attr(
										"value"); //부모댓글의 번호 
								/* console.log(greno);
