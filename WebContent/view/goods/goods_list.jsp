            ...
            <c:choose>
               <c:when test="${empty list }">
                  <div class="nosection">
                     ...
                     <h1 id="message">등록된 상품이 존재하지 않습니다.<br/><br/></h1>
                     <div>
                     <input id="btn" class="btn" type="button" value="상품등록하러가기" onclick="location.href='<%request.getContextPath();%>/YORIZORI/goods.do?command=goodsinsertform'" />
                     </div>
                  </div>
               </c:when>
