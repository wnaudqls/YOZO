...
<body>
	...
	<header id=header>
		...
		%>
			<div class="dropuserdown">
				<span id="loginStatus">${rdto.member_nick } 님이 로그인하였습니다.</span> <img
					onclick="dropuser()" class="usericon" alt="logo"
		...
		<form action="<%request.getContextPath();%>/YORIZORI/list.do?">
					<a href="" class="useId"> <input type="hidden" name="memberId"
						id="memberId" value="${rdto.member_id }" /> <input type="submit"
						value="나의 장바구니" />
		</form>
					</a> <a href="">우리집냉장고</a> <a
