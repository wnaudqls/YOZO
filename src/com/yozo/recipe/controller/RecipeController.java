      ...
      //레시피 여러개 삭제
		...
		try {
         ...
         for(int i=0;i<recipe_photo.length;i++) {
			 ...
			 * System.out.println(str.getAsString()); }
			 */
  		  RecipeDto dto=new RecipeDto(recipe_no,recipe_main_photo,member_id,recipe_title,recipe_photo1,recipe_detail1,null,recipe_material_one,cate_theme,cate_kind,recipe_material1,0);
    	  ...
    	  //레시피 리스트에서 멀티딜리트
      /*
		 * else if(command.equals("recipemuldel")) {
		 * 
		 * 
		 * 
		 * }
